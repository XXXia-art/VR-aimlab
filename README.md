...
**不要直接克隆主仓库！** 请先 Fork 到自己的 Gitee 账号下：

1. 打开项目主页：`https://gitee.com/marquerze/vr-aimlab`
2. 点击右上角的 **Fork** 按钮
3. 选择你的个人仓库，完成 Fork
...
```bash
# 注意：这里的 YOUR_NAME 换成你的 Gitee 用户名
git clone https://gitee.com/YOUR_NAME/vr-aimlab.git
```
...
```bash
cd vr-aimlab
git remote add upstream https://gitee.com/marquerze/vr-aimlab.git
```
...
# 例如：
# git checkout -b feat/add-gun-sound
# git checkout -b fix/target-spawn-bug
```
...
### 第五步：在 Gitee 上发起 Pull Request

1. 打开你的 Fork 仓库页面（`https://gitee.com/YOUR_NAME/vr-aimlab`）
2. 点击 **"Pull Request"** → **"新建 Pull Request"**
3. 源分支选择你刚推送的 `feat/xxx` 分支，目标分支选择主仓库的 `main`
4. 填写 PR 标题和描述（**说清楚改了什么、为什么改**）
...
- 主仓库地址：https://gitee.com/marquerze/vr-aimlab
